...
import { APP_ROOT,APP_ROOT_DONNEE_BASE_DEVISE, APP_ROOT_AFFECTATION_CAISSIER_CAISSE_JOURNAL, APP_ROOT_CAISSE_CAISSE_JOURNAL, APP_ROOT_CENTRE_ANALYTIQUE_DONNEE_BASE, APP_ROOT_JOURNAL_CAISSE_JOURNAL, APP_ROOT_NATURE_OPERATION_DONNEE_BASE, APP_ROOT_OPERATION_GENERAL, APP_ROOT_PLAN_COMPTABLE_DONNEE_BASE, APP_ROOT_TAUX_DONNEE_BASE, APP_STRUCTURE_SOCIETE, APP_ROOT_USER_ADMINISTRATION, APP_ROOT_STRUCTURE_SITE, APP_ROOT_STRUCTURE_DEPARTEMENT } from '../../../_core/routes/frontend.root';
