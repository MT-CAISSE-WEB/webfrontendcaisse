...
@Component({
  selector: 'app-stats-budget-annuel-chart',
  standalone: true,
  ...
  template: ` @if (budgetAnnuelValideTab.length === 0) {
      ...
      <div echarts [options]="optionsAnnuelles" style="height: 400px"></div>
    }`,
})
export class BudgetAnnuelChartComponent implements OnInit {
