...
import { validationdemandemodel } from "../model/validationdemande.model";

@Injectable({
  providedIn: 'root'
})
export class circuitvalidationservice {
    url : string = 'validationdemande' ;
   ...
   * 
   */
   update (_object : validationdemandemodel): Observable< validationdemandemodel> {
    return this.http.put < validationdemandemodel>(
      URL_LOCAL.baseUrl + this.url+"/"+_object.idvalidationdemande,_object
    );
  }
