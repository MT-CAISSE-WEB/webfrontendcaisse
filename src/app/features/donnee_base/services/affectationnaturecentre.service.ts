...
export class AffectationNatureCentreService {
  ...
  saveAffectations(idnature: string, data: any, info: any): Observable<any> {
    ...
    return this.http.post<any>(
      URL_LOCAL.baseUrl + this.url + '/' + idnature,
      payload,
    );
  }
  ...
  exportAffectations(data: any) {
    return this.http.post(
      URL_LOCAL.baseUrl + this.url + '/export/nature',
      data,
      { responseType: 'blob' },
    );
  }
  ...
  import_affectations(file: File, info: any): Observable<any> {
    ...
    return this.http.post<any>(
      URL_LOCAL.baseUrl + this.url + '/import/nature',
      formData,
    );
  }

  importAffectationsNatureFormData(formData: FormData): Observable<any> {
    return this.http.post<any>(
      URL_LOCAL.baseUrl + this.url + '/import/nature',
      formData,
    );
