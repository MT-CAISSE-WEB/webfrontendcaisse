...
import { APP_AFFECTATION_ANALYTIQUE_DONNEE_BASE } from "../../../_core/routes/frontend.root";
...
export class AffectationAnalytiqueService {
    url : string = 'affectationanalytique' ;
  ...
  update(_object: any): Observable<any> {
    return this.http.put<any>(
      URL_LOCAL.baseUrl + this.url + "/update/" + _object.idaffectation,
      _object
    );
  }
