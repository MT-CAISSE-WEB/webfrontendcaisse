...
import { APP, APP_TAUX_DONNEE_BASE, APP_TAUX, APP_PLAN_COMPTABLE_DONNEE_BASE, APP_CENTRE_ANALYTIQUE_DONNEE_BASE, APP_NATURE_OPERATION_DONNEE_BASE, APP_JOURNAL_CAISSE_JOURNAL, APP_CAISSE_CAISSE_JOURNAL, APP_AFFECTATION_CAISSIER_CAISSE_JOURNAL, APP_OPERATION, APP_OPERATION_GENERAL, APP_CIRCUIT_VALIDATEUR, APP_CIRCUIT_VALIDATION, APP_VALIDATION_DEMANDE } from './_core/routes/frontend.root';
...
import { CircuitvalidationComponent } from './features/circuit_validation/circuitvalidation/circuitvalidation.component';
import { ValidationdemandeComponent } from './features/circuit_validation/validationdemande/validationdemande.component';
import { CircuitvalidateurComponent } from './features/circuit_validation/circuitvalidateur/circuitvalidateur.component';
...
export const routes: Routes = [
    { 
        ...
        children: [   
            ...
            {
                path : APP_CIRCUIT_VALIDATEUR,
                component: CircuitvalidateurComponent,
            },

             {
                path : APP_VALIDATION_DEMANDE,
                component: ValidationdemandeComponent,
            },

             {
                path : APP_CIRCUIT_VALIDATION,
