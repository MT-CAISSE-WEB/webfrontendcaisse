...
export const APP_OPERATIONPERIODE_CONSULTATION = APP_CONSULTATION + "/" + APP_OPERATIONPERIODE;
export const APP_ROOT_OPERATIONPERIODE_CONSULTATION = APP_ROOT + "/" + APP_OPERATIONPERIODE_CONSULTATION;
