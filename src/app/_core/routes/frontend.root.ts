...
export const APP_ROOT_OPERATION_GENERAL_JUSITIFIER = APP_ROOT + '/' + APP_OPERATION_GENERAL_JUSTIFIER + '/:id';
...
export const APP_SOLDECAISSE_CONSULTATION = APP_CONSULTATION + '/' + APP_SOLDECAISSE;
export const APP_ROOT_SOLDECAISSE_CONSULTATION = APP_ROOT + '/' + APP_SOLDECAISSE_CONSULTATION;
...
//Route consultation des dépenses par caisse
export const APP_DEPNSESCAISSE = 'decaissement_operation';
export const APP_DEPNSESCAISSE_CONSULTATION = APP_CONSULTATION + "/" + APP_DEPNSESCAISSE;
export const APP_ROOT_DEPNSESCAISSE_CONSULTATION = APP_ROOT + "/" + APP_DEPNSESCAISSE_CONSULTATION;

//Route consultation des recettes par caisse
export const APP_RECETTESCAISSE = 'recettes_operation';
export const APP_RECETTESCAISSE_CONSULTATION = APP_CONSULTATION + "/" + APP_RECETTESCAISSE;
export const APP_ROOT_RECETTESCAISSE_CONSULTATION = APP_ROOT + "/" + APP_RECETTESCAISSE_CONSULTATION;

//Route des operations a justifier
export const APP_OPERATION_GENERAL_JUSTIFIER_LIST = APP_GENERAL + '/' + APP_OPERATION + '/' + 'liste_ajustifiee';
export const APP_ROOT_OPERATION_GENERAL_JUSITIFIER_LIST = APP_ROOT + '/' + APP_OPERATION_GENERAL_JUSTIFIER_LIST;