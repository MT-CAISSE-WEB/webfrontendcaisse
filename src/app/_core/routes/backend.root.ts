...
export const URL_MAIN_LOCAL = 'http://192.168.1.72:5000/';
export const URL_MAIN_LOCAL_SOCKET = 'http://192.168.1.72:5000/';

export const URL_LOCAL = {
  type: 'local',
  baseUrl: 'http://192.168.1.72:5000/api/',
  baseUrlFiles: 'http://192.168.1.72:5000/uploads/',
  baseUrlPdfs: 'http://192.168.1.72:5000/pdfs/',
};
